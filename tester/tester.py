...
import tester.types as types
import tester.event.dispatcher as dispatcher
...
class Tester:
    ...
    def _test(self, file_name, case_count, cases, time_limit, flags):
        ...
        for case in cases:
            ...
            out, err, tle, time_elapsed = run.exec_file(file_name, case.inp, time_limit)
        ...
        run.post_exec_file(file_name)

        # Dispatching finished event
