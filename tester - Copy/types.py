...
class Case:
    def __init__(self, inp, out):
        """
        Constructs a tester.types.Case object out of the following parameters
...
class Result:
    def __init__(self, case_id, case, out, err, time, code):
        """
        Result constructor, creates an tester.types.Result object with the following parameters
